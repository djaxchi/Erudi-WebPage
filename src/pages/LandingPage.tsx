        ...
        <div className="max-w-7xl mx-auto">
          ...
          <AnimatedSection delay={600}>
            <div className="flex justify-center mt-16 sm:mt-24 md:mt-32">
              <Link
                to="/about"
                className="inline-flex items-center gap-2 text-emerald-400 hover:text-emerald-300 text-lg font-semibold transition-colors duration-200"
              >
                Learn more about Erudi Desktop →
              </Link>
            </div>
          </AnimatedSection>
