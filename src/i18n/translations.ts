export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    // ── OpenSourcePage (Erudi Desktop, open source) ──────────────────────────
    'os.hero.kicker': 'Free · Open source · Fully offline',
    'os.hero.caption': 'Recorded at 38,000 ft. No signal.',
    'os.hero.h1.main': 'Your own AI,',
    'os.hero.h1.em': 'off the grid.',
    'os.hero.sub':
      'Erudi Desktop runs powerful language models entirely on your machine and grounds them in your own documents. Drop in your files, ask questions, and get answers backed by your private knowledge base. On a plane, in a bunker, completely offline. Your data never leaves your device.',
    'os.hero.download': 'Download free',
    'os.hero.see': 'see how it works',
    'os.hero.note': 'Mac (Apple Silicon, M2 or later). No account. No telemetry.',

    'os.manifesto.h2.main': 'No account. No cloud.',
    'os.manifesto.h2.em': 'No catch.',
    'os.manifesto.body':
      "Most AI tools quietly ship your prompts, your documents and your data off to someone else's servers. Erudi Desktop does the opposite. Everything runs locally, on hardware you own. Pull the network cable and it keeps working, exactly the same.",

    'os.stat.0.value': '0',
    'os.stat.0.label': 'bytes sent to the cloud',
    'os.stat.1.value': '100%',
    'os.stat.1.label': 'runs on your machine',
    'os.stat.2.value': 'Free',
    'os.stat.2.label': 'and open source, forever',

    'os.how.heading.main': 'Three steps.',
    'os.how.heading.em': "That's it.",
    'os.how.0.title': 'Drop your data',
    'os.how.0.body':
      'Drag in PDFs, notes, transcripts or spreadsheets. Erudi cleans and structures them automatically, on-device, with nothing uploaded.',
    'os.how.1.title': 'Build your knowledge base',
    'os.how.1.body':
      'Erudi reads and indexes everything into a private, on-device knowledge base. No CLI, no Python, no cloud credits. It all happens on your Mac while you watch.',
    'os.how.2.title': 'Ask it anything',
    'os.how.2.body':
      'Ask questions and get answers grounded in your sources, with citations. Online or offline, on your terms, your knowledge base is yours to keep.',

    'os.feat.heading': 'Built for people who keep their data close.',
    'os.feat.0.title': 'Complete privacy',
    'os.feat.0.body': 'Your data never leaves your machine. Ask questions and get answers with total confidence.',
    'os.feat.1.title': 'Chat with your documents',
    'os.feat.1.body': 'Drag, drop, ask. Your files become a private knowledge base the model draws on to answer.',
    'os.feat.2.title': 'Built-in arena',
    'os.feat.2.body': 'Compare answers from different local models side by side, then keep the one you trust.',
    'os.feat.3.title': 'Smart data pipeline',
    'os.feat.3.body': 'Automatic cleaning, chunking and indexing. From raw files to a searchable knowledge base.',

    'os.models.label': 'Supported models',
    'os.models.heading': 'Start from the best open models.',
    'os.models.hf': 'any Hugging Face model',

    'os.demo.label': 'Live, on-device',
    'os.demo.heading.main': 'See it think,',
    'os.demo.heading.em': 'with the Wi-Fi off.',
    'os.demo.desc':
      'This is a local session. Not a single request leaves the device. The same thing works at 38,000 feet.',
    'os.demo.footer': 'Runs on your machine, with or without a connection',
    'os.demo.0.user': 'Draft a reply to this client email while I am offline.',
    'os.demo.0.ai':
      'Done locally. Reply drafted in your tone, referencing the delivery date from the thread. Nothing left the device.',
    'os.demo.1.user': 'Summarise the 60-page report I just dropped in.',
    'os.demo.1.ai':
      'Read on-device. Key findings, risks and three action items extracted, saved right next to the original file.',
    'os.demo.2.user': 'Answer this using my research notes.',
    'os.demo.2.ai':
      'Pulled the relevant passages from your notes and answered with citations. No data uploaded, everything stayed on-device.',
    'os.demo.3.user': 'Does any of this work with no internet?',
    'os.demo.3.ai':
      'You are running it with no internet right now. Everything happens on your machine, by design.',

    'os.demo.window.title': 'Erudi · Local',
    'os.demo.window.offline': 'Airplane mode',
    'os.demo.window.you': 'You',
    'os.demo.window.ai': 'Erudi AI',
    'os.demo.window.user': 'Summarise these 4 PDFs I just dropped in.',
    'os.demo.window.answer':
      'Read all four on-device. Pulled the key dates, owners and open risks into one brief. Nothing left your laptop.',
    'os.demo.window.status': 'Running on-device · 0 ms to cloud',

    'os.cta.h2': 'Own your AI.',
    'os.cta.body':
      'Download Erudi Desktop, drop in your data, and keep everything on your side of the screen.',
    'os.cta.download': 'Download free',
    'os.cta.req': 'Mac with Apple Silicon, M2 or later. ~10 to 15 GB free disk. Windows & Linux coming soon.',
    'os.cta.license': 'Open source. Free forever.',
  ...
  fr: {
    ...
    // ── OpenSourcePage (Erudi Desktop, open source) ──────────────────────────
    'os.hero.kicker': 'Gratuit · Open source · 100% hors ligne',
    'os.hero.caption': 'Filmé à 11 000 m. Aucun réseau.',
    'os.hero.h1.main': 'Votre IA à vous,',
    'os.hero.h1.em': 'hors réseau.',
    'os.hero.sub':
      "Erudi Desktop fait tourner des modèles de langage puissants entièrement sur votre machine et les ancre dans vos propres documents. Déposez vos fichiers, posez vos questions, et obtenez des réponses appuyées sur votre base de connaissances privée. Dans un avion, dans un bunker, totalement hors ligne. Vos données ne quittent jamais votre appareil.",
    'os.hero.download': 'Télécharger gratuitement',
    'os.hero.see': 'voir comment ça marche',
    'os.hero.note': 'Mac (Apple Silicon, M2 ou plus récent). Sans compte. Sans télémétrie.',

    'os.manifesto.h2.main': 'Sans compte. Sans cloud.',
    'os.manifesto.h2.em': 'Sans piège.',
    'os.manifesto.body':
      "La plupart des outils d'IA envoient discrètement vos prompts, vos documents et vos données sur les serveurs de quelqu'un d'autre. Erudi Desktop fait l'inverse. Tout s'exécute localement, sur du matériel qui vous appartient. Débranchez le réseau et il continue de fonctionner, exactement pareil.",

    'os.stat.0.value': '0',
    'os.stat.0.label': 'octet envoyé dans le cloud',
    'os.stat.1.value': '100%',
    'os.stat.1.label': 'tourne sur votre machine',
    'os.stat.2.value': 'Gratuit',
    'os.stat.2.label': 'et open source, pour toujours',

    'os.how.heading.main': 'Trois étapes.',
    'os.how.heading.em': "C'est tout.",
    'os.how.0.title': 'Déposez vos données',
    'os.how.0.body':
      "Glissez vos PDF, notes, transcriptions ou tableurs. Erudi les nettoie et les structure automatiquement, sur votre appareil, sans rien téléverser.",
    'os.how.1.title': 'Construisez votre base de connaissances',
    'os.how.1.body':
      "Erudi lit et indexe tout dans une base de connaissances privée, sur votre appareil. Sans CLI, sans Python, sans crédits cloud. Tout se passe sur votre Mac sous vos yeux.",
    'os.how.2.title': 'Posez-lui vos questions',
    'os.how.2.body':
      "Posez vos questions et obtenez des réponses ancrées dans vos sources, avec citations. En ligne ou hors ligne, selon vos règles, votre base de connaissances est à vous.",

    'os.feat.heading': "Conçu pour ceux qui gardent leurs données près d'eux.",
    'os.feat.0.title': 'Confidentialité totale',
    'os.feat.0.body': 'Vos données ne quittent jamais votre machine. Posez vos questions et obtenez des réponses en toute confiance.',
    'os.feat.1.title': 'Discutez avec vos documents',
    'os.feat.1.body': 'Glissez, déposez, demandez. Vos fichiers deviennent une base de connaissances privée que le modèle exploite pour répondre.',
    'os.feat.2.title': 'Arène intégrée',
    'os.feat.2.body': 'Comparez les réponses de différents modèles locaux côte à côte, puis gardez celui en qui vous avez confiance.',
    'os.feat.3.title': 'Pipeline de données intelligent',
    'os.feat.3.body': 'Nettoyage, découpage et indexation automatiques. Des fichiers bruts à une base de connaissances interrogeable.',

    'os.models.label': 'Modèles supportés',
    'os.models.heading': 'Partez des meilleurs modèles ouverts.',
    'os.models.hf': "n'importe quel modèle Hugging Face",

    'os.demo.label': "En direct, sur l'appareil",
    'os.demo.heading.main': 'Regardez-le réfléchir,',
    'os.demo.heading.em': 'le Wi-Fi coupé.',
    'os.demo.desc':
      "C'est une session locale. Pas une seule requête ne quitte l'appareil. La même chose fonctionne à 11 000 mètres d'altitude.",
    'os.demo.footer': 'Tourne sur votre machine, avec ou sans connexion',
    'os.demo.0.user': 'Rédige une réponse à cet email client pendant que je suis hors ligne.',
    'os.demo.0.ai':
      "Fait localement. Réponse rédigée dans votre ton, avec la date de livraison reprise du fil. Rien n'a quitté l'appareil.",
    'os.demo.1.user': 'Résume le rapport de 60 pages que je viens de déposer.',
    'os.demo.1.ai':
      "Lu sur l'appareil. Conclusions clés, risques et trois actions extraits, enregistrés à côté du fichier d'origine.",
    'os.demo.2.user': 'Réponds à ça en utilisant mes notes de recherche.',
    'os.demo.2.ai':
      "J'ai extrait les passages pertinents de vos notes et répondu avec citations. Aucune donnée téléversée, tout est resté sur l'appareil.",
    'os.demo.3.user': 'Est-ce que tout ça marche sans internet ?',
    'os.demo.3.ai':
      "Vous l'utilisez sans internet en ce moment même. Tout se passe sur votre machine, par conception.",

    'os.demo.window.title': 'Erudi · Local',
    'os.demo.window.offline': 'Mode avion',
    'os.demo.window.you': 'Vous',
    'os.demo.window.ai': 'Erudi AI',
    'os.demo.window.user': 'Résume ces 4 PDF que je viens de déposer.',
    'os.demo.window.answer':
      "Les quatre lus sur l'appareil. Dates clés, responsables et risques ouverts réunis en une note. Rien n'a quitté votre ordinateur.",
    'os.demo.window.status': 'Exécution locale · 0 ms vers le cloud',

    'os.cta.h2': 'Votre IA vous appartient.',
    'os.cta.body':
      "Téléchargez Erudi Desktop, déposez vos données, et gardez tout de votre côté de l'écran.",
    'os.cta.download': 'Télécharger gratuitement',
    'os.cta.req': 'Mac avec Apple Silicon, M2 ou plus récent. ~10 à 15 Go de disque libre. Windows et Linux bientôt disponibles.',
    'os.cta.license': 'Open source. Gratuit pour toujours.',
